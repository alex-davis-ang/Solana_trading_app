...
class PfEditPage extends StatefulWidget {
  static const String id = 'pfedit_Screen';
  const PfEditPage({super.key});

  @override
  State<PfEditPage> createState() => _PfEditPage();
}

class _PfEditPage extends State<PfEditPage> {
  String name = "...";
  String mail = "...";
  String password = "...";
  ...
  Future<void> loadInitialValue() async {
    // Simulating a delay for loading the value (e.g., from a database, API, or local storage)
